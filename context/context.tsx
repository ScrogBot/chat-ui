...
import { performPubMedSearch, PubMedArticle, PubMedSearchResponse } from "../pubmedService" // Ensure correct import path
...
interface ChatbotUIContext {
  ...
  setPlatformTools: Dispatch<SetStateAction<Tables<"platform_tools">[]>>
...
export const ChatbotUIContext = createContext<ChatbotUIContext>({
  ...
  // PUBMED SEARCH STORE
  searchPubMed: async () => ({ query: '', results: [] }),
  pubMedArticles: [],
  setPubMedArticles: () => {}
})
...
export const ChatbotUIContextProvider: React.FC = ({ children }) => {
  ...
  const searchPubMed = async (query: string): Promise<PubMedSearchResponse> => {
    try {
      const response = await performPubMedSearch(query)
      setPubMedArticles(response.results)
      return response
    } catch (error) {
